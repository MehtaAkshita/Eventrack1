    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.blogCommentBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                firebaseFirestore.collection("Posts/" + blogPostId + "/Comments").document(currentUserId).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    @Override
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if(!task.getResult().exists()){
                            ...
                            firebaseFirestore.collection("Posts/" + blogPostId + "/Comments").document(currentUserId).set(commentsMap);
                        }else{
                            firebaseFirestore.collection("Posts/" + blogPostId + "/Comments").document(currentUserId).delete();
                        }
